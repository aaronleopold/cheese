...
export default function FileExportModal({
  ...
  function shouldShowModal() {
    return (
      flow === ApplicationFlow.RecordingStopped ||
      flow === ApplicationFlow.Screenshot
    );
  }
    ...
    <Transition.Root show={shouldShowModal()} as={Fragment}>
      ...
      >
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div className="max-w-md msm:max-w-lg inline-block align-bottom bg-white dark:bg-dark-400 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:w-full sm:p-6">
